...
deb: 00-deb 01-deb 02-deb 03-deb 04-deb 05-deb 06-deb 07-deb

rel: 00-rel 01-rel 02-rel 03-rel 04-rel 05-rel 06-rel 07-rel
...
07-deb:
	$(CC) -Wall $(DEB) -I$(VCINC) -L$(VCLIB) -lbrcmGLESv2 -lbrcmEGL -lbcm_host -o 07-egl 07-egl.c
07-rel:                                                                                          
	$(CC) -Wall $(REL) -I$(VCINC) -L$(VCLIB) -lbrcmGLESv2 -lbrcmEGL -lbcm_host -o 07-egl 07-egl.c

clean:
	rm -rf 00-mouse 01-keyboard 02-neon 03-camera 04-stream 05-neon 06-fb 07-egl rm *.s
