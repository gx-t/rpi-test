...
deb: 00-deb 01-deb 02-deb 03-deb 04-deb 05-deb 06-deb 07-deb 08-deb 09-deb 10-deb 11-deb 12-deb 13-deb 14-deb 15-deb 16-deb 17-deb 18-deb 19-deb 20-deb 21-deb 22-deb 23-deb 24-deb 25-deb 26-deb 28-deb

rel: 00-rel 01-rel 02-rel 03-rel 04-rel 05-rel 06-rel 07-rel 08-rel 09-rel 10-rel 11-rel 12-rel 13-rel 14-rel 15-rel 16-rel 17-rel 18-rel 19-rel 20-rel 21-rel 22-rel 23-rel 24-rel 25-rel 26-rel 28-rel
...
20-cflow:
	cflow --omit-arguments 20-ll.c -i x -i ^ -f dot | dot -Grankdir=LR -Tpng -o 20-ll.png
...
21-rel:
	...
	sudo chmod +s 21-nrf24l01
21-cflow:
	cflow --omit-arguments 21-nrf24l01.c -f dot  | dot -Grankdir=LR -Tpng -o 21-nrf24l01.png
...
26-deb:
	$(CC) $(DEB) -o 26-ws281x-test 26-ws281x-test.c -Lrpi_ws281x-master -Irpi_ws281x-master -lws2811 -lm
26-rel:
	$(CC) $(REL) -o 26-ws281x-test 26-ws281x-test.c -Lrpi_ws281x-master -Irpi_ws281x-master -lws2811 -lm

28-deb:
	$(CC) $(DEB) -o 28-ws281x-test 28-ws281x-test.c -Lrpi_ws281x-master -Irpi_ws281x-master -lws2811 -lm
28-rel:
	$(CC) $(REL) -o 28-ws281x-test 28-ws281x-test.c -Lrpi_ws281x-master -Irpi_ws281x-master -lws2811 -lm

clean:
	rm -rf 00-mouse 01-keyboard 02-neon 03-camera 04-stream 05-neon 06-fb 07-chirp 08-resonance 09-noise 10-resonance 11-sweep 12-evol 13-lora-tx 14-lora-rx 15-udp 16-png-evol 17-raw-evol 18-ffmpeg-evol 19-ring 20-ll 21-nrf24l01 22-temp-cgi 23-bench 24-openssl-tests 25-pki-test.cgi 26-ws281x-test 28-ws281x-test ./tags *.s rm mp4/*.mp4 flac/*.flac ogg/*.ogg *.dSYM
