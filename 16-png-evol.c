...
int rgb_save_png(unsigned width, unsigned height, png_bytep rgb_data, const char* file_name)
{
  unsigned y;
...
//  gen_random_pngs(width, height, data, 100);
  return result;
}
